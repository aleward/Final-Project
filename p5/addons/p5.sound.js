...
master = function () {
  ...
  var Master = function () {
    ...
    //TO:
    this.limiter.threshold.setValueAtTime(0, audiocontext.currentTime);
    this.limiter.ratio.setValueAtTime(20, audiocontext.currentTime);
  ...
  //TO:
  p5.soundOut._silentNode.gain.setValueAtTime(0, p5.prototype.getAudioContext().currentTime);
...
soundfile = function () {
  ...
  */
  ...
  p5.SoundFile.prototype._initSourceNode = function () {
    ...
    //TO:
    bufferSourceNode.playbackRate.setValueAtTime(this.playbackRate, ac.currentTime);
